      ...
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-inline-flex" href="index.html"><span class="text-light fs-2 fw-bold ms-2">Watch</span></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item px-2"><a class="nav-link fw-bold" href="zamowienie.html">REQUEST VIRTUAL</a></li>
            </ul>
        ...
        <div class="row">
            <div class="col-lg-3 mx-auto text-center my-5">
                ...
                <br /><br /><br /><br /><br />
              <h5 class="fs-3 fs-lg-5 lh-sm mb-0 text-uppercase">Login</h5>
        <?php
        ...
        if (filter_input(INPUT_POST, "zaloguj")) {
            ...
            if ($userId > 0) {
                ...
                echo "<a href='processLogin.php?akcja=wyloguj'>Log out</a> </p>";
                //header("location:testLogin.php");
            } else {
                echo "<p>Incorrect username or password!!!</p>";
                echo '<button onclick="window.location.href=`login.php`" class="btn btn-sm btn-outline-primary me-3">Back</button>';
